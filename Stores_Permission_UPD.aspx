<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Stores_Permission_UPD.aspx.vb" Inherits="Stores_Permission_UPD" %>
...
<asp:Button CssClass="btntt"  ID="Button1" runat="server"/>
 ...
 <asp:Panel ID="Panel2" runat="server" defaultbutton="Button1"  Direction="RightToLeft" >
  ...
  <div class="row" >
  <div class="col-3 col-s-12" id="wrapper"><asp:Label ID="Label5" runat="server" 
          CssClass="lbltt_header" Text="متابعة إذون مخزن"></asp:Label></div>
 ...
 <telerik:RadDatePicker ID="RadDatePicker1" Runat="server" Culture="ar-EG" 
                       Width="100%" Height="100%" Calendar-MonthLayout="Layout_7rows_x_6columns">
 ...
 <div class="col-3 col-s-6" style="float: right">
    ...
    <asp:Label ID="Label61" runat="server" CssClass="lbltt" Text="الصنف"></asp:Label>
    </div>
<div class="col-3 col-s-12">
<asp:TextBox ID="txtSearch0" runat="server" autofocus="true" CssClass="txttt" onkeyup="FilterItemsY(this.value)" ></asp:TextBox>
</div>
     <div class="col-3 col-s-12">
...
<%--    <asp:Label ID="Label8" runat="server" ForeColor="White" Text='<%# Eval("total_desc_Permission") %>' CssClass="lbltt" />--%>
</div>

<div class="col-3 col-s-12" style="display: inline-block">
 <asp:Button ID="Button5" runat="server" CssClass="btntt" OnClick="details" Text="V | تفاصيل الاذن" />
 </div>

     <div class="col-3 col-s-12" dir="rtl" align="center">

<asp:Repeater ID="Repeater2" runat="server" DataSourceID="SqlDataSource101" OnItemDataBound ="OnRowDataBound" Visible="False">
                                                                    
<HeaderTemplate>

<div class="col-3 col-s-12" align="center">

<asp:Label ID="Label2" runat="server" Text="تفاصيل الاذن" CssClass="lbltt"></asp:Label>
...
<div style="border: thin solid #673492; background-color: #2d2926">
...
<div class="col-3 col-s-12" align="center">
<asp:Label ID="Label4" runat="server" Text="موظف المخزن" CssClass="lbltt_header" Width="45%"></asp:Label>



<asp:Label ID="Label28" runat="server" Text="متابعة المخزن" CssClass="lbltt_header" Width="45%"></asp:Label>

</div>


<div class="col-3 col-s-12" align="center">
<asp:Label ID="Label30" runat="server" Text='<%# Bind("Person_Name") %>' CssClass="txttt" Width="45%"></asp:Label>



<asp:Label ID="Label32" runat="server" Text='<%# Bind("TransReview_UpdateDate", "{0: yyyy-MM-dd}") %>' CssClass="txttt"  Width="45%"></asp:Label>

</div>
<div class="col-3 col-s-6" align="center"><asp:DropDownList ID="DropDownList6" runat="server" CssClass="droptt"></asp:DropDownList></div>
<div class="col-3 col-s-12" align="center"><asp:Button ID="Button1" runat="server" OnClick="details_Status" Text="تعديل" CssClass="btntt" /></div>
<asp:Label ID="Label61" runat="server" Text='<%# Bind("TransReviewStatus_Code") %>' Visible="False"></asp:Label>
                                        
<asp:Label ID="Label_identity" runat="server" Text='<%# Bind("InventoryTrans_Code") %>' Visible="False"></asp:Label>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource101" runat="server" 
                            ...
                            <SelectParameters>
                                <asp:ControlParameter ControlID="Invoice_SerialLabel" Name="Invoice_Serial" 
                                    PropertyName="Text" />
                            </SelectParameters>
                        </asp:SqlDataSource>
...
<td align="center" dir="rtl" valign="middle">
    ...
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
        ...
        SelectCommand="SELECT PERSON.Person.Person_Code, PERSON.Person.Person_Name + ' ** ' + PERSON.PersonType.PersonType_Desc AS Person_Name FROM PERSON.Person INNER JOIN PERSON.PersonType ON PERSON.Person.PersonType_code = PERSON.PersonType.PersonType_code ORDER BY PERSON.Person.PersonType_code,PERSON.Person.Person_Name ">
    </asp:SqlDataSource>
